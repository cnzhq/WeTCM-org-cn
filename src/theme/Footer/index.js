...
const footerColumns = [
  ...
  // },
  {
    ...
    links: [
      ...
      {label: '作者', to: '/blog/authors'},
      {label: '档案', to: '/blog/archive'},
    ],
  },
  {
    title: '站点服务',
    links: [
      {label: 'GitHub', href: 'https://github.com/cnzhq/WeTCM-org-cn'},
    ...
    <footer className="wetcmFooter" aria-labelledby="wetcm-footer-title">
      <div className="wetcmFooterInner">
        <section className="wetcmFooterNotes" aria-labelledby="wetcm-footer-title">
          ...
          <p>
            本站内容用于学习、阅读与资料整理，不提供任何诊断、处方或治疗建议。如有身体不适，请咨询
            <Link href="https://zgcx.nhc.gov.cn/doctor">
              具备资质的医师
            </Link>
            。
          </p>
        ...
        <div className="wetcmFooterLegal">
          <p>Copyright © {year} WeTCM. 保留所有权利。</p>
          <ul>
            <li>
